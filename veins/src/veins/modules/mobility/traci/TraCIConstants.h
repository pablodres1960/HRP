...
// PABLO CURRENT BATERYCAPACITY (get: vehicle)
#define VAR_CURRENTBATTERYCAPACITY 0x21

// PABLO OBTENGO EL DESTINO DE LA RUTA DOUBLE (get: vehicle)
#define VAR_DESTINATION 0x25
